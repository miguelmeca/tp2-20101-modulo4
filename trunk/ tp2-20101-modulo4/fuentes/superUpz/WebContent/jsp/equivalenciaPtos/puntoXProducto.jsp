            ...
            <td colspan="4" ><table width="459" border="0">
              <tr>
                ...
                <td width="73"><div align="left">
                  <input type="text" name="txtMonto1" id="txtDescipcionProducto2" style="width:60px" class="text  ui-corner-all" />
                </div></td>
                <td width="81"><div align="left">Puntos:(<span class="style3">*</span>) </div></td>
                <td width="67"><div align="left">
                  <input type="text" name="txtPuntos1" id="txtPuntos1" style="width:60px" class="text  ui-corner-all" />
                </div></td>
              </tr>
              <tr>
                ...
                <td><div align="left">
                  <input type="text" name="txtMonto2" id="txtMonto2" style="width:60px" class="text  ui-corner-all" />
                </div></td>
                <td><div align="left">Puntos:</div></td>
                <td><div align="left">
                  <input type="text" name="txtPuntos2" id="txtPuntos2" style="width:60px" class="text  ui-corner-all" />
                </div></td>
              </tr>
              <tr>
                ...
                <td><div align="left">
                  <input type="text" name="txtMonto3" id="txtMonto3" style="width:60px" class="text  ui-corner-all" />
                </div></td>
                <td><div align="left">Puntos:</div></td>
                <td><div align="left">
                  <input type="text" name="txtPuntos3" id="txtPuntos3" style="width:60px" class="text  ui-corner-all" />
                </div></td>
              </tr>
            </table></td>
            </tr>
          <tr >
            <td colspan="4" align="left" ><span class="style3">(*) Debe realizar el ingreso de al menos un valor del monto y punto. </span></td>
            </tr>
        </table>			</td>
            </tr>
        </table>        
