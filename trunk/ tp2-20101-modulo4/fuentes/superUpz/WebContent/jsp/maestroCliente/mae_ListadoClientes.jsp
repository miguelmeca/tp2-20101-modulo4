            ...
            <td width="62%" class="ui-accordion-content"><table width="100%" border="0">
              <tr>
				...
				<div id="divDocumento" style="position:relative;top: 0px;left: 0px ">N&uacute;mero:
                      <input name="txtDNIBuscar" type="text" size="25px"  maxlength="100" value="" >
                </div>
				<div id="divNombres" style="position:relative;top: 0px;left: 0px ">
					<div id="divNombreCliente">Nombre:
						  <input name="txtNombreBuscar" type="text" size="25px"  maxlength="100" value="" >
					</div>
					<div id="divPaternoCliente">Nombre:
						  <input name="txtPaternoBuscar" type="text" size="25px"  maxlength="100" value="" >
					</div>
					<div id="divMaternoCliente">Nombre:
						  <input name="txtMaternoBuscar" type="text" size="25px"  maxlength="100" value="" >
					</div>
                </div>
