...
<tr>
	<td class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" align="center"> Agregar Cuenta Adicional </td>
</tr>
  <tr>
...
<input type="hidden" name="hddCodigoCuenta" id="hddCodigoCuenta" value="<%=cuentaCodigo%>" />
<input type="hidden" name="hddCodigoCli" id="hddCodigoCli" value="<%=codigoCliente%>" />
<input type="hidden" name="hddNombreCliente" id="hddNombreCliente" value="<%=nombreCliente%>" />
<input type="hidden" name="hddNumeroTarjeta" id="hddNumeroTarjeta" value="<%=numTarjeta%>" />
