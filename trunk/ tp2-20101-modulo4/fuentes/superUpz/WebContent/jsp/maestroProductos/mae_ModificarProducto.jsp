<%--
*Resumen
*Objeto                 : mae_ModificarProducto.jsp.
* Descripcion           : pagina para mantener un producto.
...
<table width="1010px" border="0">
	<tr>
		<td
			...
			align="center">Modificar Producto</td>
	</tr>
	<tr>
						...
						<table border="0">
							...
							<tr>
								...
								<td align="left" style="height: 31px; width: 420px;"><textarea
									...
									<input type="hidden" name="hddOperacion" id="hddOperacion" value="actualizarProducto" />
									</td>
