 ...
 * 
 */
public class ReporteConstrucctor {

	/**
	 * Constructor por defecto de la clase. Sin parámetros. Sin Exception.
	 */
	public ReporteConstrucctor() {
	}

	/**
	 * Método para poner el mismo estilo a un conjunto de celdas. Si alguna de
	 * las filas o celdas de la hoja incluidas en el intervalo no existen
	 * entonces se crean, si ya existen solo se les asigna el estilo.
	 * 
	 * @param sHoja
	 *            hoja excel, de tipo HSSFSheet.
	 * @param estilo
	 *            estilo a aplicar, de tipo HSSFCellStyle.
	 * @param filaIni
	 *            fila de inicio, de tipo int.
	 * @param colIni
	 *            columna de inicio, de tipo short.
	 * @param filaFin
	 *            fila final, de tipo int.
	 * @param colFin
	 *            columna final, de tipo short.
	 */
	public void ponerEstiloRango(HSSFSheet sHoja, HSSFCellStyle estilo,
			int filaIni, short colIni, int filaFin, short colFin) {
	...
	/**
	 * Método para poner el mismo estilo a un conjunto de celdas de una fila. Si
	 * alguna de las filas o celdas de la hoja incluidas en el intervalo no
	 ...
	 * 
	 * @param objFila
	 *            fila de la hoja, de tipo HSSFRow.
	 * @param estilo
	 *            estilo a aplicar, de tipo HSSFCellStyle.
	 * @param colIni
	 *            columna de inicio, de tipo short.
	 ...
	 *            estilo a aplicar, de tipo HSSFCellStyle.
	 * @param columna
	 *            columna de la hoja, de tipo short.
	 * @param filaIni
	 *            fila de inicio, de tipo int.
	 * @param filaFin
	 *            fila final, de tipo int.
	...
	/**
	 * Método para asignar un valor y un estilo a una celda. Si la celda no
	 * existe entonces se crea, si ya existe solo se le asigna el estilo y el
	 * valor.
	 * 
	 * @param objFila
	 *            fila de la celda, de tipo HSSFRow.
	 * @param columna
	 *            columna de la hoja, de tipo short.
	 * @param estilo
	 *            estilo a aplicar, de tipo HSSFCellStyle.
	 * @param valor
	 *            valor a colocar, de tipo String.
	 */
	 ...
	 *            estilo a aplicar, de tipo HSSFCellStyle.
	 * @param valor
	 *            valor a colocar, de tipo double.
	 */
	public void ponerCelda(HSSFRow objFila, short columna,
	 ...
	 *            estilo a aplicar, de tipo HSSFCellStyle.
	 * @param valor
	 *            valor a colocar, de tipo boolean.
	 */
	public void ponerCelda(HSSFRow objFila, short columna,
	 ...
	 *            estilo a aplicar, de tipo HSSFCellStyle.
	 * @param valor
	 *            valor a colocar, de tipo Calendar.
	 */
	public void ponerCelda(HSSFRow objFila, short columna,
	 ...
	 *            estilo a aplicar, de tipo HSSFCellStyle.
	 * @param colorindex
	 *            indice del color, de tipo short.
	 */
	 ...
	 * 
	 * @param sHoja
	 *            Hoja Excel que contiene a las columnas, de tipo HSSFSheet.
	 * @param colIni
	 *            Numero de columna inicial, de tipo short.
	 * @param colFin
	 *            Numero de columna final, de tipo short.
	 * @param ancho
	 *            ancho a colocar en las columnas, de tipo short.
	 */
	public void ponerAnchoColumnas(HSSFSheet sHoja, short colIni, short colFin,
			short ancho) {
	 ...
	 *            Hoja Excel, de tipo HSSFSheet.
	 * @param filaIni
	 *            Numero de fila inicial, de tipo int.
	 * @param colIni
	 *            Numero de columna inicial, de tipo short.
	 * @param filaFin
	 *            Numero de fila final, de tipo int.
	 * @param colFin
	 *            Numero de columna final, de tipo short.
	 */
	public void combinarColumnas(HSSFSheet sHoja, int filaIni, short colIni,
	 ...
	 *            Numero de columna final, de tipo short.
	 */
	public void combinarFilas(HSSFSheet sHoja, int filaIni, short colIni,
			int filaFin, short colFin) {
	...
	/**
	 * Busca una cadena en la hoja Excel y devuelve la posicion de la celda que
	 * lo contiene en un arreglo de dos elementos: [0] es la fila, y [1] es la
	 * columna. Si no lo encuentra devuelve null.
	 * 
	 * @param sHoja
	 *            Hoja Excel, de tipo HSSFSheet.
	 * @param cadena
	 *            Texto a buscar, de tipo String.
	 * @return Un arreglo de enteros con dos elementos: [0] es la fila, y [1] es
	 *         la columna. Si no lo encuentra devuelve null.
	 */
	 ...
	 * 
	 * @param sHoja
	 *            Objeto que representa a la hoja Excel con los datos.
	 * @param institucion
	 *            Valor a colocar como nombre de la institución.
	 * @param area
	 *            Valor a colocar como nombre del área o división.
	 * @param sistema
	 *            Valor a colocar como el nombre del Sistema.
	 * @param fecha
	 *            Fecha a colocar en el reporte.
	 * @param hora
	 *            Hora a colocar en el reporte.
	 * @param usuario
	 *            Login del usuario a colocar en el reporte.
	 * @param finReporte
	 *            Valor a colocar como fin de reporte.
	 */
	public void cabeceraReporte(HSSFSheet sHoja, String institucion,
			String area, String sistema, String fecha, String hora,
			String usuario, String finReporte) {
		// -- 1. Institucion
		int filaIniCab = 0;
		short colIniCab = 0;
		...
		if (posToken != null) {
			...
			if (sHoja.getRow(filaIniCab) != null) {
				if (sHoja.getRow(filaIniCab).getCell(colIniCab) != null)
					sHoja.getRow(filaIniCab).getCell(colIniCab).setCellValue(
							institucion);
			}
		}
	...
	/**
	 * Metodo utilizado para agregar la etiqueta de fin de reporte en los
	 * reportes Excel.
	 * 
	 * @param sHoja
	 *            Objeto que representa a la hoja Excel con los datos.
	 ...
	 *            Valor a colocar como fin de reporte.
	 */
	public void finReporte(HSSFWorkbook wb, HSSFSheet sHoja, String finReporte,
			int columna) {
	 ...
	 *            nombre de la fuente
	 * @param italic
	 *            indicador de fuente cursiva
	 * @return retorna el estilo de la fuente de la celda
	 */
	public HSSFFont getFuente(HSSFWorkbook libro, short tamano,
			String nomFuente, boolean italic) {
		HSSFCellStyle estilo = libro.createCellStyle();
	 ...
	 *            estilo de la celda
	 */
	public void setCelda(HSSFWorkbook libro, HSSFSheet hoja, HSSFRow fila,
			HSSFCell celda, short posColumna, String valor, HSSFCellStyle estilo) {
	 ...
	 *            celda de la fila
	 * @param posColInicial
	 *            posición de columna inicial
	 * @param posColFinal
	 *            posición de columna inicial
	 * @param estilo
	 *            estilo de la celda
	 */
	public void setRangoCeldaVacias(HSSFWorkbook libro, HSSFSheet hoja,
			HSSFRow fila, HSSFCell celda, short posColInicial,
			short posColFinal, HSSFCellStyle estilo) {
	 ...
	 *            estilo de la celda
	 */
	public void setEstiloCeldas(HSSFWorkbook libro, HSSFSheet hoja,
			HSSFRow fila, HSSFCell celda, short posColInicial,
			short posColFinal, HSSFCellStyle estilo) {
		for (int i = posColInicial; i <= posColFinal; i++) {
			celda = fila.createCell((short) i);
